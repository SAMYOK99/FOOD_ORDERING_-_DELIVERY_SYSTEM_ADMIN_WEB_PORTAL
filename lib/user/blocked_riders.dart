...
class BlockedRiders extends StatefulWidget {
  const BlockedRiders({super.key});

  @override
  State<BlockedRiders> createState() => _BlockedRidersState();
}

class _BlockedRidersState extends State<BlockedRiders> {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        ...
                        {
                          dialogBoxForUnBlockingUserAccount(allRiders!.docs[i].id);
